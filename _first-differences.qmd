# First Differences: One Antidote to Non-Stationarity {background-image="images/bg-muskrat.jpeg" background-opacity=0.5}

## Are these two metrics correlated? {background-image="images/bg-muskrat.jpeg" background-opacity=0.5}
...
## A scatterplot, perhaps? {background-image="images/bg-muskrat.jpeg" background-opacity=0.5}
...
# If they're correlated, then when one *moves*, the other will *move similarly.* {background-image="images/bg-muskrat.jpeg" background-opacity=0.5}

# When one metric increases, the other should increase similarly. {background-image="images/bg-muskrat.jpeg" background-opacity=0.5}

# When one metric decreases, the other should decrease similarly. {background-image="images/bg-muskrat.jpeg" background-opacity=0.5}

# Let's look at the [changes]{.underline} rather than the [actual values]{.underline}. {background-image="images/bg-muskrat.jpeg" background-opacity=0.5}

# This is called [first differences]{.underline}. {background-image="images/bg-muskrat.jpeg" background-opacity=0.5}
...
## The scatterplot of the first differences is...different! {background-image="images/bg-muskrat.jpeg" background-opacity=0.5}
...
# These are both moving with time (but not directly with each other) {background-image="images/bg-muskrat.jpeg" background-opacity=0.5}
