# First Differences: Avoiding Seeing Correlation Where It Is Not {background-image="images/bg-muskrat.jpeg"}

## Are these two metrics correlated? {background-image="images/bg-muskrat.jpeg"}
...
## A scatterplot, perhaps? {background-image="images/bg-muskrat.jpeg"}
...
# If they're correlated, then when one *moves*, the other will *move similarly.* {background-image="images/bg-muskrat.jpeg"}

# When one metric increases, the other should increase similarly. {background-image="images/bg-muskrat.jpeg"}

# When one metric decreases, the other should decrease similarly. {background-image="images/bg-muskrat.jpeg"}

# Let's look at the [changes]{.underline} rather than the [actual values]{.underline}. {background-image="images/bg-muskrat.jpeg"}

# This is called [first differences]{.underline}. {background-image="images/bg-muskrat.jpeg"}
...
## The scatterplot of the first differences is...different! {background-image="images/bg-muskrat.jpeg"}
...
# These are both moving with time (but not directly with each other) {background-image="images/bg-muskrat.jpeg"}
