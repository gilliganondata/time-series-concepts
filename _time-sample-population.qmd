## Our data exists over time. {background-color="#3F2D76&C" transition="fade"}
...
## So, what is our [population]{style="text-decoration: underline;"}? {background-color="#3F2D76&C" transition="fade"}
...
## Is it the [past]{.underline} to the [present]{.underline}? {background-color="#3F2D76&C" transition="fade"}
...
## Maybe it's the [past]{.underline}, [present]{.underline}, and [future]{.underline}? {background-color="#3F2D76&C" transition="fade"}
...
## Or...just the [future]{.underline}? {background-color="#3F2D76&C" transition="fade"}
...
::: {.absolute top="500" left="200"}
[But...we can't sample from the future!]{.h2-chars}
:::

# So...what is our [sample]{.underline}? {background-color="#3F2D76&C"}

## Our sample is a [sample timeframe]{style="text-decoration: underline;"}. {background-color="#3F2D76&C" transition="fade"}
...
## This is [imperfect]{.underline}. {background-color="#3F2D76&C" transition="fade"}
...
## Because our reality is [constant change]{.underline}. {background-color="#3F2D76&C" transition="fade"}
