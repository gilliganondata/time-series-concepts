...
## Consider a fairly "clean" series {background-image="images/bg-heron.jpeg" transition="fade"}
...
```
## The Mean...is Pretty Meaningless {background-image="images/bg-heron.jpeg" transition="fade"}
...
```
## And so is the variance {background-image="images/bg-heron.jpeg" transition="fade"}
...
## The "decomposition" is into three components {background-image="images/bg-heron.jpeg" auto-animate="true"}
...
## Our original mean and variance now seems...embarrassing? {background-image="images/bg-heron.jpeg"}
...
## We can use the seasonal and trend components for the "mean" {background-image="images/bg-heron.jpeg"}
...
## And the "variance" is [just]{.underline} based on "what's left" {background-image="images/bg-heron.jpeg"}
