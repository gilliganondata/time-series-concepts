# Decomposition {background-color="#04447B33"}

# [Time-Series]{.underline} Decomposition, That Is {background-color="#04447B33"}

## Consider a fairly "clean" series {background-color="#04447B33" transition="fade"}
...
```
## The Mean...is Pretty Meaningless {background-color="#04447B33" transition="fade"}
...
```
## And so is the variance {background-color="#04447B33" transition="fade"}
...
# Time-series decomposition does what our brain already wants to do {background-color="#04447B33"}

## The "decomposition" is into three components {background-color="#04447B33" auto-animate="true"}
...
## Our original mean and variance now seems...embarrassing? {background-color="#04447B33"}
...
## We can use the seasonal and trend components for the "mean" {background-color="#04447B33"}
...
## And the "variance" is [just]{.underline} based on "what's left" {background-color="#04447B33"}
...
# This is powerful! {background-color="#04447B33"}

# (Loosely) it's part of what's happening with our next example. {background-color="#04447B33"}
