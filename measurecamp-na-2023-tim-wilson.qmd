...
author: "Tim Wilson<br>MeasureCamp North America 2023"
format:
  revealjs: 
...
title-slide-attributes:
  data-background-image: images/bg-mcamp-cbus.jpeg
...
# Let's think about time. {background-color="#5A3B727C" background-image="images/bg-mallards.jpeg"}
...
::: {.column width="60%"}
![DALL-E 2: "A puppy attending the MeasureCamp analytics conference, digital art"](images/puppy_measurecamp.png)
:::
:::
